...
1. Выполнить команду `npm i`/`yarn install`
1. Выполнить команду `npm run init` (выдать права на исполнение файлов)
1. Выполнить команду `npm link [--force]` ([--force] - нужен в случае повторной линковки)
1. Выполнить одну из двух команд: `date-getter` или `vang-ui`
